...
void runBC(GRGraph *output, BC_Parameter *parameter) {
  ...
  util::GRError(problem->Reset(0, enactor->GetFrontierType(), max_queue_sizing,
                               max_queue_sizing1),
 ...
 */
void dispatchBC(GRGraph *grapho, const GRGraph *graphi, const GRSetup *config,
 ...
 */
void gunrock_bc(GRGraph *grapho, const GRGraph *graphi, const GRSetup *config,
